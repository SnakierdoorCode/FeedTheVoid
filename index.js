var Godot = (() => {
  ...
  return async function(moduleArg = {}) {
    ...
    function _godot_js_emscripten_get_version() {
      const emscriptenVersionPtr = GodotRuntime.allocString("4.0.15");
